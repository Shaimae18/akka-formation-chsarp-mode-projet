    ...
    public class GrilleService : IGrilleService
    {
        ...
        public IEnumerable<Position> GetInitialPositionInGrille(Joueur currentJoueur, int nombreEnnemie)
        {
            return new List<Position>()
            {
                ...
                new Position(0,10, new Joueur(){PointsVie=1,TypeJoueur= TypeJoueur.Adversaire,Etat=Etat.Vivant,PersonnageJoueur= new PersonnageJoueur(pseudo:"Adv1",cote:Cote.Obscur,typePersonnage:TypePersonnage.NonLanceurDeSort)}),
            };
        }
    }
}
